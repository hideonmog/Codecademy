...
def create_dictionary(names, months, years, max_sustained_winds, areas_affected, damages, deaths):
    """ create dictionary with key as names and values as a dictionary of the rest of the data  """
...
def sort_by_year(hurricanes):
    """ convert dictionary with name as key to one with year as key """
    hurricanes_by_year = {}
    for cane in hurricanes:
        current_year = hurricanes[cane]["Year"]
        current_cane = hurricanes[cane]
        if current_year not in hurricanes:
...
def affected_areas_count(hurricanes):
    """ finds how many times an area is affected and returns a dictionary with key as the affected area and value as count  """
...
affected_areas_count = affected_areas_count(hurricanes)
...
def most_deaths(hurricanes):
    """ finds the highest mortality hurricane and the amount of deaths it caused """
...
def sort_by_mortality(hurricanes):
    """ categorise hurricanes by a mortality rating into a dictionary """
...
def greatest_damage(hurricanes):
    """ finds the hurricane which caused the greatest damage and how costly it was """
...
def sort_by_damage(hurricanes):
  """ categorise hurricanes by damage into a dictionary """
  ...
  hurricanes_by_damage = sort_by_damage(hurricanes)
